  ...
  const chatContent = !activeId ? (
    ...
    <>
      ...
      >
        ...
        <UserAvatar {...memberAvatarProps(activePeer, peerName)} size={32} className="sm:hidden shrink-0" />
        <UserAvatar {...memberAvatarProps(activePeer, peerName)} size={40} className="hidden sm:block shrink-0" />
          ...
          {showNewChat ? (
            <div className="p-2 space-y-1">
              ...
              {filteredMembers.length === 0 ? (
                ...
                filteredMembers.map((member) => (
                  ...
                  >
                    <UserAvatar {...memberAvatarProps(member)} size={40} />
                    <div className="min-w-0 flex-1">
            ...
            filteredConversations.map((conv) => {
              ...
              return (
                ...
                >
                  <UserAvatar {...memberAvatarProps(member, name)} size={44} />
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
